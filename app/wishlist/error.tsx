      ...
      <main className="flex-grow flex items-center justify-center px-4 py-20">
        <div className="bg-white border border-black/10 p-8 md:p-12 rounded-lg shadow-sm max-w-md w-full space-y-6">
          ...
          <div>
            ...
            <h2 className="text-2xl font-bold text-black">Failed to Load Wishlist</h2>
          </div>
          <p className="text-sm text-stone-600 leading-relaxed">
            We couldn't retrieve your saved items right now. Please try again or go back to the home page.
          </p>
