      ...
      <main className="flex-grow py-16 px-6 md:px-10">
        <div className="max-w-[1560px] mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#121212]/70">+977 986-5900094</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#121212]/70">info@thestylezone.com.np</p>
                  </div>
                </div>
            ...
            <div className="bg-white border border-[#121212]/5 rounded-[4px] p-8 animate-on-scroll">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold uppercase tracking-wider text-[#121212]/50 block">
                    Name <span className="text-[#FE5733]">*</span>
                  </label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold uppercase tracking-wider text-[#121212]/50 block">
                    Phone <span className="text-[#FE5733]">*</span>
                  </label>
                  <input
                    required
                    type="tel"
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-[#121212]/50 block">
                    Email (OPTIONAL)
                  </label>
                  <input
                    type="email"
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold uppercase tracking-wider text-[#121212]/50 block">
                    Message <span className="text-[#FE5733]">*</span>
                  </label>
                  <textarea
                    required
                    rows={4}
              ...
              {status === 'success' && (
                <div className="mt-4 bg-green-500 text-white text-xs font-bold uppercase tracking-widest p-2 rounded-[3px] flex items-center gap-3">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-white border border-[#121212]/5 rounded-[4px] overflow-hidden">
              <iframe
            ...
            <div className="text-center mt-4">
               ...
               <a href="https://maps.app.goo.gl/wnT364rpT3dJE1gu7"
                target="_blank"
