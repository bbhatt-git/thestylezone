          ...
          <header className="flex flex-col gap-8">
            ...
            <div className="relative max-w-md">
              <input
                ...
                className="h-14 w-full rounded-sm border border-stone-300 bg-white pe-24 pl-12 text-sm text-[#121212] placeholder:text-[#121212]/40 focus:outline-none focus:border-[#FE5733]"
              />
